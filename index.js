...
// Your code here...
console.log(string2[string2.indexOf('C')]+
...
// Your code here...
const favFruit = "lemon";
const favFruitIndex = fruit.indexOf(favFruit)
const favFruitLentgh = favFruit.length
console.log(fruit.slice(favFruitIndex,favFruitIndex+favFruitLentgh))
